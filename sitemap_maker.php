...
if(isset($_POST['website']){ 
    ...
    define ("OUTPUT_FILE", "sitemap_name_of_site.xml");
...
function Scan ($url)
{
    ...
    // Program start
    define ("VERSION", "2.1");                                            
    define ("AGENT", "Mozilla/5.0 (compatible; PHP XML Sitemap Generator/" . VERSION . ")");
    define ("NL", CLI ? "\n" : "<br>");
    ...
    fwrite ($pf, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" .
                 "<!-- Created Sitemap Generator " . VERSION . " http://www.jobseen.in -->\n" .
